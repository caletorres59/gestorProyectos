...
app.service('registroService', function($http, $httpParamSerializerJQLike) {
    ...
    this.registro = function(datos) {
        ...
        alert("estoy en el servicio" + datos.nombreUsuario);
        var promise = $http({
            method: "post",
            url: "/registroUsuario",
    ...
    this.modificar = function(identificacion) {
        ...
        var promise = $http({
            ...
            data: $httpParamSerializerJQLike({
                ...
                latitud: identificacion.latitud,
                longitud: identificacion.longitud,
                hectareas: identificacion.hectareas
            }),
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded'
            }
